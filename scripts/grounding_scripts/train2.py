...
from lib.visual_grounding.solver2 import Solver
from lib.config_grounding import CONF
from models.refnet.refnet2 import RefNet
...
def get_solver(args, dataloader):
    ...
    #CONF.PATH.OUTPUT = os.path.join(CONF.PATH.OUTPUT, 'visual_grounding')
