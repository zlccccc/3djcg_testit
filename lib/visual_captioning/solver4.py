...
from lib.visual_captioning.eval_helper4 import eval_cap
    ...
    def _dump_log(self, phase, is_eval=False):
        if phase == "train" and not is_eval:
            log = {
                ...
                "score": ["lang_acc", "cap_acc", "ori_acc", "obj_acc", "pred_ious", "pos_ratio", "neg_ratio", "max_iou_rate_0.25", "max_iou_rate_0.5"]
            }
            for key in log:
                for item in log[key]:
